...
const mensageGetReady = {
    ...
    draw() {
      contexto.drawImage(  
        ...
        contexto.drawImage(  
          sprites,
          global.floor.spriteX, global.floor.spriteY, // Sprite x, Sprite Y
          global.floor.width, global.floor.height, //Tamanho da Sprite
          (global.floor.PositionX + global.floor.width), global.floor.PositionY,
          global.floor.width, global.floor.height
          );
    }
}
...
function createPipes() {
  const pipes = {
    ...
    draw() {
      ...
      pipes.pairs.forEach(function(even){
        ...
        contexto.drawImage(  
          ...
          pipes.width, pipes.height, //Tamanho da Sprite
          pipeSkyX, pipeSkyY,
    ...
    collisionWithTheFlappyBird(even) {
      ...
      const footOfFlappyBird = global.flappyBird.PositionY + global.flappyBird.height;
